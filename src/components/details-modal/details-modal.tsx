            ...
            <div className="mobile-view">
                ...
                <div className="desktop-detail">
                    ...
                    <p className="details-modal__description">
                        ...
                        chop biltong cupim strip steak. Kevin prosciutto
                        porchetta bacon boudin, jowl filet mignon chislic.
                        Tenderloin turkey rump sirloin tail burgdoggen hamburger
                        frankfurter kevin sausage ham hock chuck prosciutto
                        short ribs. Jerky turkey ground round pork shoulder
                        rump. Bacon ipsum doloeeeeer amet salami leberkas filet
